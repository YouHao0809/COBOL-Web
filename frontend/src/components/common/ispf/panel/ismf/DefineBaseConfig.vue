<template>
    <div class="master-panel">
        <a-spin :spinning="isLoading" size="large">
            ...
            <h3 class="panel-title">SCDS BASE DEFINE</h3>
            <div class="panel-content">
                ...
                <a-row class="panel-name">To DEFINE SCDS Base, Specify:</a-row>
                <a-row>
                    <a-input
    ...
    export default {
        ...
        methods: {
            onEnter() {
                ...
                this.isLoading = true;
                Axios.post(`/api/sms/base-configuration`, params)
                    .then(res => {
