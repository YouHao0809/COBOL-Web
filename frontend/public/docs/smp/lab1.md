...
//JOB1211 JOB 1752079,YOUHAO, NOTIFY=&SYSUID,
...
//JOB1212 JOB 1752079,YOUHAO, NOTIFY=&SYSUID,
//         CLASS=A,MSGCLASS=A,MSGLEVEL=(1,1)
//INITCSI EXEC PGM=IDCAMS,REGION=0M
//SMPCSI DD DSN=ST015.TDMF.SMP.CSI,
//        DISP=OLD
...
```
//JOB1213 JOB 1752079,YOUHAO, NOTIFY=&SYSUID,
//         CLASS=A,MSGCLASS=A,MSGLEVEL=(1,1)
//CRTDS PROC SMPPRFX='ST015.TDMF.SMP',BLKSZ=27920
//SMPE EXEC PGM=GIMSMP,REGION=0M
//SMPCSI DD DSN=ST015.TDMF.SMP.CSI,DISP=OLD
//SMPLIST DD SYSOUT=*
//SYSPRINT DD SYSOUT=*
...
//SMPCNTL DD *
  ...
  UCLIN.
    ADD GLOBALZONE
        ...
        SREL(Z038)
        ZONEINDEX(
       (TZONE,ST015.TDMF.SMP.CSI,TARGET),
       (DZONE,ST015.TDMF.SMP.CSI,DLIB)).
       ADD OPTIONS(TDMOPT)
           ASM(ASMUTIL)
           LKED(LINKEDIT)
           DSPREFIX(ST015.TDMF.SMP)
       ...
       ADD DDDEF(SMPLOG) DA(ST015.TDMF.SMP.SMPLOG) MOD.
       ADD DDDEF(SMPLOGA) DA(ST015.TDMF.SMP.SMPLOGA) MOD.
       ADD DDDEF(SMPLTS) DA(ST015.TDMF.SMP.SMPLTS) SHR.
       ADD DDDEF(SMPMTS) DA(ST015.TDMF.SMP.SMPMTS) SHR.
       ADD DDDEF(SMPPTS) DA(ST015.TDMF.SMP.SMPPTS) SHR.
       ADD DDDEF(SMPSCDS) DA(ST015.TDMF.SMP.SMPSCDS) SHR.
       ADD DDDEF(SMPSTS) DA(ST015.TDMF.SMP.SMPSTS) SHR.
     ENDUCL .
...
```
//JOB1214 JOB 1752079,YOUHAO, NOTIFY=&SYSUID,
//         CLASS=A,MSGCLASS=A,MSGLEVEL=(1,1)
//CRTDS PROC SMPPRFX='ST015.TDMF.SMP',BLKSZ=27920
//SMPE EXEC PGM=GIMSMP,REGION=0M
//SMPCSI DD DSN=ST015.TDMF.SMP.CSI,DISP=OLD
...
```
//JOB1215 JOB 1752079,YOUHAO, NOTIFY=&SYSUID,
//         CLASS=A,MSGCLASS=A,MSGLEVEL=(1,1)
//CRTDS PROC SMPPRFX='ST015.TDMF.SMP',BLKSZ=15920
//SMPE EXEC PGM=GIMSMP,REGION=0M
//SMPCSI DD DSN=ST015.TDMF.SMP.CSI,DISP=OLD
//SMPLIST DD SYSOUT=*
//SYSPRINT DD SYSOUT=*
